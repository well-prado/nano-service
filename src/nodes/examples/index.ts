...
import MCPServerUI from "./mcp-server/ui";
import MCPServerCustomUI from "./mcp-server-custom";
...
import ChatGPTUI from "./chatgpt-ui";
import MCPClient from "./mcp-client";
import WeatherToolNode from "./weather-tool-node";
...
const ExampleNodes = {
	...
	"mcp-server-ui": new MCPServerUI(),
	"mcp-server-custom-ui": new MCPServerCustomUI(),
	"chatgpt-ui": new ChatGPTUI(),
	"mcp-client": new MCPClient(),
	"weather-tool-node": new WeatherToolNode(),
};
